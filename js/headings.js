...
afqb.global.updateHeadings = function () {
    ...
    document.title = afqb.global.settings.html.title || "test";
    ...
    if (afqb.global.settings.html.link) {
        ...
        a.innerHTML = afqb.global.settings.html.title || "test";
        title.innerHTML = "";
        title.appendChild(a);
    } else {
        title.innerHTML = afqb.global.settings.html.title || "test";
    }
